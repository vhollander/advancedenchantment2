...
public class Corrupt extends AEEnchantable {
    public Corrupt() {
    ...
    public void onTargetDamaged(net.minecraft.entity.LivingEntity user, net.minecraft.entity.Entity target, int level) {
        ((LivingEntity)target).addStatusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, level * 400, -level, false, true, true));
    }
