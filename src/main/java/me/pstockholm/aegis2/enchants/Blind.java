...
public class Blind extends AEEnchantable {
    public Blind() {
    ...
    public void onTargetDamaged(net.minecraft.entity.LivingEntity user, net.minecraft.entity.Entity target, int level) {
        ((LivingEntity)target).addStatusEffect(new StatusEffectInstance(StatusEffects.BLINDNESS, (int)(level/3) * 400, 0, false, true, true));
    }
