...
public class Stun extends AEEnchantable {
    public Stun() {
    ...
    public void onTargetDamaged(net.minecraft.entity.LivingEntity user, net.minecraft.entity.Entity target, int level) {
        ...
        ((LivingEntity)target).addStatusEffect(new StatusEffectInstance(StatusEffects.WEAKNESS, (int)(level/3) * 400, 0, false, true, true));
