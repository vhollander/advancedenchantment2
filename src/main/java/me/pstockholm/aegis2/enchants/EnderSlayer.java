...
public class EnderSlayer extends AEEnchantable {
    public EnderSlayer() {
    ...
    public void onTargetDamaged(net.minecraft.entity.LivingEntity user, net.minecraft.entity.Entity target, int level) {
        ...
        if (target.isAlive() && target.getType() == EntityType.ENDERMAN || target.getType() == EntityType.ENDER_DRAGON || target.getType() == EntityType.ENDERMITE) {      
