...
public class Ward extends AEEnchantable {
    public Ward() {
    ...
    public void onUserDamaged(net.minecraft.entity.LivingEntity user, net.minecraft.entity.Entity target, int level) {
        ...
        ((LivingEntity)user).addStatusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 5, 0, false, true, true));
        user.getRecentDamageSource();
    }
